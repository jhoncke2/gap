...
List<FormularioOld> formularios = [
  FormularioOld.fromJson(formAtFormFieldsFillingOut),
  FormularioOld.fromJson(formAtFirstFirmerFillingOut),
  FormularioOld.fromJson(formAtSecondaryFirmersFillingOut),
  FormularioOld.fromJson({
