...
class IdsStorageManager{
  ...
  static Future addProjectId(int id)async{
    ...
    await StorageConnectorSingleton.storageConnector.setMapResource(idsDataKey, projectsIdsToJson(projectsIdsTree));
  }

  static Future<List<StorageIdProject>> _getProjectsIdsFromStorage()async{
    final Map<String, dynamic> jsonProjects = await StorageConnectorSingleton.storageConnector.getMapResource(idsDataKey);
  ...
  static Future _updateProjectsIdsInStorage(List<StorageIdProject> idProjects)async{
    await StorageConnectorSingleton.storageConnector.setMapResource(idsDataKey, projectsIdsToJson(idProjects));
  }
}