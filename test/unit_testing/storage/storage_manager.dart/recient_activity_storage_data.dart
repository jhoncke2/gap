...
final String visitsAsString = jsonEncode(Visits(visits: fakeData.visits.getRange(0, 4).toList()).toJson());
final String chosenVisitAsString = jsonEncode(fakeData.visits[0].toJson());
final String formsAsString = jsonEncode(Formularios(formularios: fakeData.formularios.getRange(0, 2).toList()).toJson());
