...
final String visitsAsString = jsonEncode(OldVisits(visits: fakeData.visits).toJson());
final String chosenVisitAsString = jsonEncode(fakeData.visits[0].toJson());
final String formsAsString = jsonEncode(OldFormularios(formularios: fakeData.formularios).toJson());
