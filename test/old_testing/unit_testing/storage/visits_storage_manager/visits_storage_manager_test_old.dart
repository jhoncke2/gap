...
Future<void> _tryTestGetVisits()async{
  final List<VisitOld> visits = await VisitsStorageManager.getVisits();
...
void _compararParDeVisits(VisitOld v1, VisitOld v2){
...
Future<void> _tryTestSetChosenVisit()async{
  final VisitOld chosenOne = fakeData.visits[0];
